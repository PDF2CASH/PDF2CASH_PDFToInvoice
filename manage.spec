...
a = Analysis(['manage.py'],
             ...
             'rest_framework_jwt.utils','rest_framework.parsers','worker.urls','apigateway.urls', '_sqlite3', 'packaging.version', 'packaging.specifiers', 'packaging.requirements','pyimod03_importers', '_ctypes'],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],
